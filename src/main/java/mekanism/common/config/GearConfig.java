...
public class GearConfig extends BaseMekanismConfig {
    ...
    private final TomlConfig configSpec;
    ...
    GearConfig(String modId) {
        super(modId);
        TomlConfig.Builder builder = new TomlConfig.Builder();
    ...
    @Override
    public TomlConfig getConfigSpec() {
        return configSpec;
    }

    @Override
    public EnvType getConfigType() {
