...
public class ModuleData<MODULE extends ICustomModule<MODULE>> implements IHasTranslationKey, IModuleDataProvider<MODULE> {
    ...
    public static class ModuleDataBuilder<MODULE extends ICustomModule<MODULE>> {
         ...
         */
        public static <MODULE extends ICustomModule<MODULE>> ModuleDataBuilder<MODULE> custom(@Nonnull Supplier<MODULE> customModule,
        ...
        private ModuleDataBuilder(@Nonnull Supplier<MODULE> supplier, @Nonnull IItemProvider itemProvider) {
