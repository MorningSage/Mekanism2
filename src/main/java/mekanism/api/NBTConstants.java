...
public final class NBTConstants {
    ...
    public static final int TAG_TYPE_END         = 0;
    public static final int TAG_TYPE_BYTE        = 1;
    public static final int TAG_TYPE_SHORT       = 2;
    public static final int TAG_TYPE_INT         = 3;
    public static final int TAG_TYPE_LONG        = 4;
    public static final int TAG_TYPE_FLOAT       = 5;
    public static final int TAG_TYPE_DOUBLE      = 6;
    public static final int TAG_TYPE_BYTE_ARRAY  = 7;
    public static final int TAG_TYPE_STRING      = 8;
    public static final int TAG_TYPE_LIST        = 9;
    public static final int TAG_TYPE_COMPOUND    = 10;
    public static final int TAG_TYPE_INT_ARRAY   = 11;
    public static final int TAG_TYPE_LONG_ARRAY  = 12;
    public static final int TAG_TYPE_ANY_NUMERIC = 99;
}
