...
public class ChemicalUtils {
     ...
     * @return Chemical.
     */
    public static <CHEMICAL extends Chemical<CHEMICAL>> CHEMICAL readChemicalFromNBT(@Nullable NbtCompound nbtTags, CHEMICAL empty, String nbtName, Function<Identifier, CHEMICAL> registryLookup) {
     ...
     * @return Chemical.
     */
    public static <CHEMICAL extends Chemical<CHEMICAL>> CHEMICAL readChemicalFromRegistry(@Nullable Identifier name, CHEMICAL empty, Registry<CHEMICAL> registry) {
        if (name == null) {
            return empty;
        }
