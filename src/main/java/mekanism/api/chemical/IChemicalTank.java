...
import mekanism.api.toport.FluidAction;
...
public interface IChemicalTank<CHEMICAL extends Chemical<CHEMICAL>, STACK extends ChemicalStack<CHEMICAL>> extends IEmptyStackProvider<CHEMICAL, STACK>,
    INBTSerializable<NbtCompound>, IContentsListener {
     ...
     * <strong>NOT</strong> be directly called outside of your own {@link IChemicalTank} where you already know the given {@link ChemicalStack} is valid, or on the
    ...
    default NbtCompound serializeNBT() {
        ...
        if (!isEmpty()) {
            nbt.put(NBTConstants.STORED, getStack().write(new NbtCompound()));
        }
        return nbt;
    }
}
